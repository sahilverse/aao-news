                    ...
                    <div class="approval-tools">
                        <div class="search-container">
                            <input type="text" id="publisherSearchInput"
                                placeholder="Search by name, email, or organization..." class="search-input">
                                            ...
                                            <div class="card-footer">
                                                <div class="action-buttons">
                                                    <button class="action-btn approve-btn"
                                                        onclick="approvePublisher(${publisher.publisherId}, '${publisher.publisherName}')"
                                                        title="Approve Publisher">
                                                        <i class="fas fa-check"></i>
                                                        Approve
                                                    </button>
                                                    <button class="action-btn reject-btn"
                                                        onclick="rejectPublisher(${publisher.publisherId}, '${publisher.publisherName}')"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="confirmation-content">
                            ...
                            <p>Are you sure you want to approve <span id="approvePublisherName"></span> as a publisher?
                            </p>
                    ...
                    <div class="modal-footer">
                        ...
                        <form id="approveForm" method="post"
                            action="${pageContext.request.contextPath}/admin/publisher-approval?action=approve">
                            <input type="hidden" id="approvePublisherId" name="publisherId"
                                value="${publisher.publisherId}">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form id="rejectForm" method="post"
                            action="${pageContext.request.contextPath}/admin/publisher-approval?action=reject">
                            <input type="hidden" id="rejectPublisherId" name="publisherId"
                                value="${publisher.publisherId}">
