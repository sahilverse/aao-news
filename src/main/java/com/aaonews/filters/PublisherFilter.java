...
/**
 * Filter to restrict access to publisher-only resources
 */
@WebFilter("/publisher/*")
public class PublisherFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        // Check if user is logged in and has PUBLISHER role
        if (currentUser != null && currentUser.getRole() == Role.PUBLISHER) {
            // User is a publisher, allow access
